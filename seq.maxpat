...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 159.25, 108.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
,
					"patching_rect" : [ 121.0, 715.734375, 50.5, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 107.0, 390.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 172.5, 390.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 444.0, 230.96875, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 170.0, 144.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 142.0, 102.0, 35.0 ],
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 178.0, 100.0, 50.5, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 68.0, 283.0, 39.0, 22.0 ],
									"text" : "/ 120."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 236.734375, 37.0, 22.0 ],
									"text" : "when"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 193.734375, 258.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 68.0, 365.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 187.5, 129.0, 59.5, 129.0 ],
									"order" : 1,
									"source" : [ "obj-68", 0 ]
								}
...
,
					"patching_rect" : [ 53.0, 137.0, 46.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 518.0, 277.46875, 35.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 486.0, 673.0, 44.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.0, 277.46875, 29.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 53.0, 105.0, 42.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 261.0, 74.0, 66.0, 22.0 ],
					"text" : "route reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 108.0, 239.0, 102.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 758.734375, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 53.0, 511.734375, 48.0, 22.0 ],
					"text" : "seq-len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 69.5, 351.734375, 48.0, 22.0 ],
					"text" : "seq-len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 78.0, 197.0, 48.0, 22.0 ],
					"text" : "seq-len"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 149.0, 237.734375, 272.0, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 131.5, 390.234375, 272.0, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 121.0, 551.734375, 272.0, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 306.734375, 51.0, 53.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 204.25, 455.234375, 124.25, 455.234375, 124.25, 343.734375, 108.0, 343.734375 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 0.701960784313725 ],
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 221.75, 302.734375, 137.75, 302.734375, 137.75, 190.0, 116.5, 190.0 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 62.5, 345.1171875, 79.0, 345.1171875 ],
					"order" : 1,
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 0.701960784313725 ],
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 193.75, 616.734375, 115.75, 616.734375, 115.75, 506.734375, 91.5, 506.734375 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.917647058823529, 1.0, 0.074509803921569, 1.0 ],
					"destination" : [ "obj-19", 0 ],
					"source" : [ "obj-59", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.364705882352941, 0.0, 1.0, 1.0 ],
					"destination" : [ "obj-19", 0 ],
					"order" : 1,
					"source" : [ "obj-63", 0 ]
				}
